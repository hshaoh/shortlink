...
import com.saas.shortlink.project.dao.entity.LinkBrowserStats;
...
public interface LinkBrowserStatsMapper extends BaseMapper<LinkBrowserStats> {
    ...
    @Insert("""
            ...
            """)
    void shortLinkBrowserState(@Param("linkBrowserStats") LinkBrowserStats linkBrowserStats);
    ...
    @Select("""
            ...
            WHERE 
                ...
                AND tlbs.date BETWEEN CONCAT(#{param.startDate},' 00:00:00') AND CONCAT(#{param.endDate},' 23:59:59') 
            GROUP BY 
                tlbs.full_short_url, tl.gid, tlbs.browser;
            """)
    List<HashMap<String, Object>> listBrowserStatsByShortLink(@Param("param") ShortLinkStatsDTO requestParam);
    ...
    @Select("""
            ...
            GROUP BY 
                tl.gid, tlbs.browser;
            """)
    List<HashMap<String, Object>> listBrowserStatsByGroup(@Param("param") ShortLinkGroupStatsDTO requestParam);
}
